...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		JMenuItem mntmUserGuide = new JMenuItem("Open User Guide");
		mnHelp.add(mntmUserGuide);
		mntmUserGuide.addActionListener(arg -> AdminTool.openUserGuide());
		
		JMenuItem mntmDeveloperGuide = new JMenuItem("Open Developer Guide");
		mnHelp.add(mntmDeveloperGuide);
		mntmDeveloperGuide.addActionListener(arg -> AdminTool.openDeveloperGuide());
